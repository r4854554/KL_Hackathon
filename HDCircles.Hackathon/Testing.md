...
<meta content="HDCircles.Hackathon/Testing.md · refactor · HDCircles / KL-Hackathon / mavic-air-uwp" property="og:title">
...
<meta content="https://gitlab.com/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="HDCircles.Hackathon/Testing.md · refactor · HDCircles / KL-Hackathon / mavic-air-uwp" property="twitter:title">
...
<title>HDCircles.Hackathon/Testing.md · refactor · HDCircles / KL-Hackathon / mavic-air-uwp · GitLab</title>
...
<script>
  window.uploads_path = "/HDCircles/kl-hackathon/mavic-air-uwp/uploads";
</script>

<meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="ZL1B74zQgLYVesDruHlDMufaX8ARAaKCg0BMEUMUDsGyG+dMcnzeC1tFGQGshBMleABuBMtGyYmq0aMyq34hew==" />
...
<li class=""><a title="Operations" aria-label="Operations" href="/-/operations"><svg class="s18"><use xlink:href="https://gitlab.com/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#dashboard"></use></svg>
</a></li>
</ul>
...
</li><li class=""><a class="shortcuts-container-registry" href="/HDCircles/kl-hackathon/mavic-air-uwp/container_registry"><div class="nav-icon-container">
...
</a></li><li class=""><a title="Integrations" href="/HDCircles/kl-hackathon/mavic-air-uwp/settings/integrations"><span>
Integrations
</span>
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="HDCircles.Hackathon/Testing.md" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md"><strong>Testing.md</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/HDCircles/kl-hackathon/mavic-air-uwp/blame/refactor/HDCircles.Hackathon/Testing.md">Blame</a><a class="btn" href="/HDCircles/kl-hackathon/mavic-air-uwp/commits/refactor/HDCircles.Hackathon/Testing.md">History</a><a class="btn js-data-file-blob-permalink-url" href="/HDCircles/kl-hackathon/mavic-air-uwp/blob/4f4c963f1004b0da6b388ee5288226710eab3849/HDCircles.Hackathon/Testing.md">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;HDCircles.Hackathon/Testing.md&quot;,&quot;gfm&quot;:&quot;`HDCircles.Hackathon/Testing.md`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="https://gitlab.com/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
<small>
122 Bytes
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;af21f09d038b9824f7dfdd85821ee95b42e534d0&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="https://gitlab.com/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/HDCircles/kl-hackathon/mavic-air-uwp/raw/refactor/HDCircles.Hackathon/Testing.md"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="HDCircles.Hackathon/Testing.md" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/HDCircles/kl-hackathon/mavic-air-uwp/raw/refactor/HDCircles.Hackathon/Testing.md?inline=false"><svg><use xlink:href="https://gitlab.com/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#download"></use></svg></a></div>
<div class="btn-group" role="group">
<a class="btn js-edit-blob  btn-sm" href="/HDCircles/kl-hackathon/mavic-air-uwp/edit/refactor/HDCircles.Hackathon/Testing.md">Edit</a><a class="btn btn-default btn-sm" href="/-/ide/project/HDCircles/kl-hackathon/mavic-air-uwp/edit/refactor/-/HDCircles.Hackathon/Testing.md">Web IDE</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md">Fork</a>
...
<div class="blob-viewer hidden" data-type="simple" data-url="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md?format=json&amp;viewer=simple">
...
<div class="blob-viewer" data-rich-type="markup" data-type="rich" data-url="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md?format=json&amp;viewer=rich">
<div class="text-center prepend-top-default append-bottom-default">
<i aria-hidden="true" aria-label="Loading content…" class="fa fa-spinner fa-spin fa-2x"></i>
</div>
...
<h3 class="page-title">Delete Testing.md</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/HDCircles/kl-hackathon/mavic-air-uwp/blob/refactor/HDCircles.Hackathon/Testing.md" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="+Ro2OnI6F7HKJY1uUyMVs7OH8c6AqAU8Tp/o8aKWL6kvvJCZjJZJDIQaVIRH3kWkLF3AClrvbjdnDgfSSvwAEw==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-a1d8563f26ac2a03345d6e11de658858">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-a1d8563f26ac2a03345d6e11de658858" class="form-control js-commit-message" placeholder="Delete Testing.md" required="required" rows="3">
Delete Testing.md</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-8a40dbacad8ce62bf6ff528e21210dd9" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-8a40dbacad8ce62bf6ff528e21210dd9">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace Testing.md</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/HDCircles/kl-hackathon/mavic-air-uwp/update/refactor/HDCircles.Hackathon/Testing.md" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="12ALuBAHStuyTFVUKx/LK7PRpI9Gcbck70SvbmicVVcBxq0b7qsUZvxzjL4/4ps8LAuVS5w23C/G1UBNgPZ67Q==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-55db1fbd49e49254b86791dedb07bd72">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-55db1fbd49e49254b86791dedb07bd72" class="form-control js-commit-message" placeholder="Replace Testing.md" required="required" rows="3">
Replace Testing.md</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-890b4d43a8b0073f479416b625c2c026" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-890b4d43a8b0073f479416b625c2c026">Start a <strong>new merge request</strong> with these changes
</label></div>
